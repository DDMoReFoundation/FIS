...
public class FISPropertyPlaceholderConfigurer extends PropertyPlaceholderConfigurer {
    ...
    private void validateProperties(Properties properties) {
        final String[] requiredProperties = new String[] {
            "fis.publishInputs", "fis.retrieveOutputs", "mif.url", "converter.toolbox.executable", "execution.host.fileshare.local", "execution.host.fileshare", "execution.host.fileshare.remote"
        };
