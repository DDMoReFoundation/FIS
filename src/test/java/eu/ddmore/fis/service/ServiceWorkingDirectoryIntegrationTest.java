...
public class ServiceWorkingDirectoryIntegrationTest {
    ...
    @Test
    public void newDirectory_shouldCreateANewDirectoryWithAGivenName() {
        ...
        assertEquals("Directory should have expected name.","my-directory", file.getName());
    }

    @Test
    public void newDirectory_shouldCreateANewDirectoryWithRandomName() {
        File file = instance.newDirectory();
